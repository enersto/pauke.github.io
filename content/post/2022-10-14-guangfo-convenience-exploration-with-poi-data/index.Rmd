---
title: "广佛生活便利程度街镇分布情况——基于POI数据的街镇格栅分析 （一）"
author: pauke
date: '2022-10-14'
...
```{r base_population,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
广佛核心区的人口数量情况
```{r base_population_fc,fig.height=8.5, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r bs_data_explore,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r bs_point,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r bs_final,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
地铁车站POI数据的情况是：
```{r ms_point,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
ggplot()+ geom_sf(data = gz_t_ms_1,aes(geometry = geometry))+
  geom_sf(data = poi_ms,aes(geometry = geometry))
...
```{r ms,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_data_explore,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_data_clean,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_data_format,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_fc,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_cs,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
核心区域的便利店密度情况：
```{r mk_cs_fc,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_sp,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_sp_fc,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
```{r mk_fm,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
...
核心区域的便利店密度情况：
```{r mk_fm_fc,fig.height=8, fig.width=10, warning=FALSE,  dpi= 200}
